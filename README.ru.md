...
Cask устанавливает Tunnelblick Reset 1.1.0 для Apple Silicon или Intel. Инструкции по настройке Touch ID находятся в [README проекта](https://github.com/viktoraseev/dns-reset-tunnelblick/blob/main/README.ru.md).
